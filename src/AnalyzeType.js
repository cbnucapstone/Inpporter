...
function PresentationType() {
  ...
  return (
  <div style={{paddingBottom: "6%", backgroundImage: "url(./background-img.jpg)", backgroundSize: "1600px 500px", backgroundRepeat: "no-repeat"}}>
    <div id="presentation-type">

     <Link to="/"><div id="info-type-one">
